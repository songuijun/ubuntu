...
int main(int argc, char **argv)
{
    ...
    ros::Subscriber sub_line			= n.subscribe(line_topic,  10, VISION_Callback);
    ros::Subscriber sub_yaw				= n.subscribe(yaw_topic,   10, YAW_Callback);
    ros::Subscriber sub_sonar			= n.subscribe(sonar_topic, 10, SONAR_Callback);
